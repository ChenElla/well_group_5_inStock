...
export default function InventoryDetails() {
    ...
    function returnStock() {
        if (selectedItem?.status === 'In Stock') {
            return (
                <p className="detail__text detail__text--in-stock">IN STOCK</p>
            );
        } else {
            return (
                <p className="detail__text detail__text--off-stock">
                    OUT OF STOCK
                </p>
            );
        }
                    ...
                    <div className="detail__container__header">
                        <div className="detail__container__title-wrapper">
                            <img
                                ...
                                alt="back arrow"
                            />
                            <h1 className="detail__container__title">{selectedItem.item_name}</h1>
                        </div>
                        <Link
